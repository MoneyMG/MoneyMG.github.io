...
risksector <- ttrisksector %>%
  ...
  dplyr::mutate(color = ifelse(Sector %in% c("ENERGIES", "GRAINS", "METALS", "SOFTS"), '#f5a800', '#081F2D'))


correctorder <- c("ENERGIES", "GRAINS", "METALS", "SOFTS" , "CURRENCIES", "EQUITIES", "RATES & CASH")
